...
function Sidebar() {
    return (
        <motion.div
            className='w-32 md:w-60 md:relative md:z-0 fixed z-10 top-0  bg-accent-200 h-[100vh] overflow-auto scrollbar scrollbar-thumb-gray-500 scrollbar-track-gray-200'>
